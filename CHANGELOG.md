...
- Support SemVer patch version matching of non-numeric characters following [SemVer formatting rules](https://semver.org/#backusnaur-form-grammar-for-valid-semver-versions) (e.g. `1.2.3-alpha.7+secret-release`)
